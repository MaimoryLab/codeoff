...
class AppLocalizations {
  ...
  static const _values = <String, Map<String, String>>{
    'en': {
      ...
      'working': 'Working',
      'takeOver': 'Take over',
      'continueThread': 'Continue conversation',
      ...
      'threadReleasedByServer': 'Conversation released by server',
      'attachFileOrImage': 'Attach file or image',
      'chooseImages': 'Choose images',
      'chooseFiles': 'Choose files',
      'searchNames': 'Search names',
      'noMatchingEntries': 'No matching folders or files',
    ...
    'zh': {
      ...
      'threadReleasedByServer': '对话被服务端释放',
      'attachFileOrImage': '添加文件或图片',
      'chooseImages': '选择图片',
      'chooseFiles': '选择文件',
      'searchNames': '搜索名称',
      'noMatchingEntries': '没有匹配的目录或文件',
